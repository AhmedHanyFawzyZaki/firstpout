<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	<?php echo $form->textFieldRow($model,'date_of_album',array('class'=>'span5')); ?>

	<?php echo $form->textFieldRow($model,'pic_date',array('class'=>'span5')); ?>

	<?php echo $form->textFieldRow($model,'private',array('class'=>'span5')); ?>

	<?php echo $form->textFieldRow($model,'belong_to_me',array('class'=>'span5')); ?>
