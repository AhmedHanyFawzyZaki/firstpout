...
<div class="album-lightbox" style="width:590px;float:left;padding:0;">
    <div class="album-wrap" style="background:#FFF;width:540px;margin:0 auto;border-radius:5px;">
        <h2 class="album-title" style="color:#e74c3c;border-bottom:1px solid #f0f3f4;padding:10px 25px;font-size:16px;font-weight:bold;"><?= $album->title ?></h2>
            ...
            <div class="list-medias" style="width:100%;height:auto;">
                ...
                if ($images) {
                    foreach ($images as $image) {
                		...
                		ob_end_clean();
                        ?>
                        <a href="<?=Yii::app()->request->baseUrl?>/home/ViewImage?id=<?=$image->id?>&mode=AlbumImage" class="album-img fancybox" style="float:left;width:95px;;margin:5px 6px 5px 0px;border:0px;">
                            <?=$im?>
                        </a>
                        <?php
                    }
		...
		?>
        <div class="album-overview">
            <div class="albums-details" style="width:100%;">
                <div class="right-cont" style="width:100%;">
                    <div style="margin-top: 20px;">
                        <div style="color:#3b5998;cursor: pointer;">
                            <span onclick="likeImage('Album',<?= $album->id ?>)" id="al_like_unlike"><?= $i_liked ? 'Unlike' : 'Like' ?></span>
                            &nbsp;.&nbsp;
                            ...
                            if ($comments) {
                                foreach ($comments as $comment) {
                                    ...
                                    <div class="img-comm-cont">
                                        ...
                                        <span class="img-comm-cont-span" style="width:92%;">
                        ...
                        <div style="background:#e9eaed;padding:2px;color:#3b5998;display: table;width: 100%;border-bottom: 1px solid #fff;">
                            ...
                            <textarea id="al_img_reply" onkeypress="if (event.keyCode == 13 && event.shiftKey === false) {
                                    commentImage('Album',<?= $album->id ?>)
                                }" style="border: 0 none;border-radius: 0;float: left;margin-left: 4px;padding: 3px;resize: none;width: 92%;margin-bottom: 5px;"></textarea>
                        </div>
                    </div>
                </div>
