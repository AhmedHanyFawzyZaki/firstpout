...
<div id="timeline-board" class="page-wrap">
    <div class="page-head">
        <div class="page-actions family-tabs">
            ...
            <a href="<?= Yii::app()->request->baseUrl ?>/controlPanel/createProfile" class="profile-link current">
                Create Profile
            </a>
    ...
    <section class="page-contain">
        ...
        ?>
        <h1><?=$model->isNewRecord?'Create':'Edit'?> User profile!</h1>
        <fieldset>
            ...
            <div class="control-group">
                <label class="control-label" for="profile-name">USER PICTURE:<small>Little description of photo uploading here</small></label>
                <div class="controls">
