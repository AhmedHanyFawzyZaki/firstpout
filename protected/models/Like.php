...
class Like extends CActiveRecord
{
	...
	protected function afterSave() {
		if($this->item_type==1){
			...
			$message='<a href="'.Yii::app()->request->baseUrl.'/userProfile/index/'.$this->user_id.'">'.$this->user->username.'</a> has liked a <a href="'.Yii::app()->request->baseUrl.'/groups/index/'.$item->group_id.'#article-'.$item->id.'">post</a> you ';
			...
			$user_id=$item->user_id;
			$message='<a href="'.Yii::app()->request->baseUrl.'/userProfile/index/'.$this->user_id.'">'.$this->user->username.'</a> has liked an <a href="'.Yii::app()->request->baseUrl.'/controlPanel/viewAlbum/'.$item->id.'">album</a> you ';
			...
			$message='<a href="'.Yii::app()->request->baseUrl.'/userProfile/index/'.$this->user_id.'">'.$this->user->username.'</a> has liked an <a href="'.Yii::app()->request->baseUrl.'/home/viewImage?id='.$item->id.'&mode=AlbumImage" class="fancybox">album image</a> you ';
			...
			$message='<a href="'.Yii::app()->request->baseUrl.'/userProfile/index/'.$this->user_id.'">'.$this->user->username.'</a> has liked a <a href="'.Yii::app()->request->baseUrl.'/home/viewImage?id='.$item->id.'&mode=PostMedia" class="fancybox">post</a> you ';
			...
			$user_id=$item->user_id;
			$message='<a href="'.Yii::app()->request->baseUrl.'/userProfile/index/'.$this->user_id.'">'.$this->user->username.'</a> has liked an <a href="'.Yii::app()->request->baseUrl.'/home/viewImage?id='.$item->id.'&mode=PostImage" class="fancybox">image</a> you ';
			...
			$user_id=$item->user_id;
			$message='<a href="'.Yii::app()->request->baseUrl.'/userProfile/index/'.$this->user_id.'">'.$this->user->username.'</a> has liked a <a href="'.Yii::app()->request->baseUrl.'/home/viewContest/'.$item->id.'">contest entry</a> you ';
			...
			$message='<a href="'.Yii::app()->request->baseUrl.'/userProfile/index/'.$this->user_id.'">'.$this->user->username.'</a> has liked a <a href="'.Yii::app()->request->baseUrl.'/home/viewImage?id='.$item->id.'&mode=ContestUserImage">contest image</a> you ';
		}
		$msg='<a href="'.Yii::app()->request->baseUrl.'/userProfile/index/'.$this->user_id.'">'.$this->user->username.'</a> has liked '.$link;
